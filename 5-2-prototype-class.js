...
// const banana = new User({
//   name: "banana@mail.com",
//   age: 39,
//   numberOfPosts: 50,
//   topics: ["sports", "health"],
// });
// console.log(banana.getInfo());
// poly.updatePostCount(10);
// console.log(banana.getInfo());
...
// Example 2 - Сховище
// Напиши клас Storage який створює об'єкти для
// керування складом товарів.При виклику отримуватиме один
// аргумент - початковий масив товарів і записуватиме його
// властивість items.
...
// login та email.Оголоси приватні властивості #login
// та #email, доступ до яких зроби через гетер та сетер
// login та email.
...
// console.log("old login", poly.login); // Poly
// poly.login = "Polycutie";
// console.log("new login", poly.login); // Polycutie
...
// Priority, у якому зберігатиметься об'єкт із пріоритетами.
...
//   addNote(note) {
//     if (!this.getItems().includes(note)) {
...
// { isOpen: boolean } і оголошує одну властивість on - стан
// вкл / викл(true / false).За замовчуванням значення
// властивості on повинно бути false.
